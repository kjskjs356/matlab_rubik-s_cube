...
while(Up5.UserData~=Up2.UserData)||(Up5.UserData~=Up4.UserData)||(Up5.UserData~=Up6.UserData)||(Up5.UserData~=Up8.UserData)

if(Up5.UserData~=Up2.UserData)&&(Up5.UserData~=Up4.UserData)&&(Up5.UserData~=Up6.UserData)&&(Up5.UserData~=Up8.UserData)
    algorithm(9)
    
elseif(Up5.UserData==Up2.UserData)&&(Up5.UserData==Up4.UserData)
    algorithm(9)
    
elseif(Up5.UserData==Up4.UserData)&&(Up5.UserData==Up6.UserData)
    algorithm(9)
    
elseif(Up5.UserData==Up4.UserData)&&(Up5.UserData==Up8.UserData)
    Rotation_function(17)
    pause(sec);
    
elseif(Up5.UserData==Up6.UserData)&&(Up5.UserData==Up8.UserData)
    Rotation_function(17)
    pause(sec);
    Rotation_function(17)
    pause(sec);
    
elseif(Up5.UserData==Up2.UserData)&&(Up5.UserData==Up6.UserData)
    Rotation_function(18)
    pause(sec);
    
elseif(Up5.UserData==Up2.UserData)&&(Up5.UserData==Up8.UserData)
    Rotation_function(17)
    pause(sec);
end
end
